<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\PhpStudy\PHPTutorial\WWW\relaxed\public/../application/common\view\tpl\dispatch_jump.tpl";i:1526467896;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="system-message <?php echo $codeText; ?>">
            <div class="image">
                <img src="/relaxed/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo $msg; ?></h1>
            <p class="jump">
