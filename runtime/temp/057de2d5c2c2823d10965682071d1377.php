<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:98:"C:\PhpStudy\PHPTutorial\WWW\relaxed\public/../application/admin\view\merchandise\product\edit.html";i:1541380713;s:78:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\layout\default.html";i:1526467896;s:75:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\common\meta.html";i:1526467896;s:77:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\common\script.html";i:1526467896;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-desc" data-rule="required" class="form-control" name="row[desc]" type="text" value="<?php echo $row['desc']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Carid'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-carid" data-rule="required" class="form-control" name="row[carid]" type="text" value="<?php echo $row['carid']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sum" data-rule="required" class="form-control" name="row[sum]" type="number" value="<?php echo $row['sum']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Surplus'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-surplus" data-rule="required" class="form-control" name="row[surplus]" type="number" value="<?php echo $row['surplus']; ?>">
        </div>
    </div>
    <div class="form-group">
