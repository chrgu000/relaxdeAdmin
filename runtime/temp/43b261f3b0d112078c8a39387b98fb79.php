<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"C:\PhpStudy\PHPTutorial\WWW\relaxed\public/../application/admin\view\index\index.html";i:1526467896;s:75:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\common\meta.html";i:1526467896;s:77:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\common\header.html";i:1538015460;s:75:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\common\menu.html";i:1540799920;s:78:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\common\control.html";i:1526467896;s:77:"C:\PhpStudy\PHPTutorial\WWW\relaxed\application\admin\view\common\script.html";i:1526467896;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini">轻松一刻</span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b>轻松一刻</b></span>
</a>
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="/relaxed/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/relaxed/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/relaxed/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/relaxed/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
